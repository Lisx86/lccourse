...
int main(){
    ...
    for(int i=0;i<=symbols_registered;i++)
    {
        if(symbols[i]!='\0')
        {
            cout<<symbols[i]<<" "<<count[i]-1<<endl;
        }
    }
}